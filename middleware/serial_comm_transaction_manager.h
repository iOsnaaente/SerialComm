...
/**
 * @brief Maximum simultaneous transactions
 */
#ifndef SERIAL_COMM_MAX_TRANSACTIONS
    #define SERIAL_COMM_MAX_TRANSACTIONS 16
#endif
...
class SerialCommTransactionManager {
    ...
    private:
         ...
         */
        Transaction transactions_[ SERIAL_COMM_MAX_TRANSACTIONS ];
